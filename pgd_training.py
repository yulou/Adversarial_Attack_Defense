...
def adversarial_training(
    ...
    for epoch in range(num_epochs):
        ...
        clean_acc, clean_loss_avg, adv_acc, adv_loss_avg = evaluate_pgd(model, test_loader, device, epsilon, alpha, num_iter)
        ...
        if test_acc > best_test_acc:
            ...
            torch.save(model.state_dict(), f'./pgd_8_255/best_finetuned_pgd_ep_{epsilon:.2f}_alpha_{alpha:.2f}.pt')
...
torch.save(model.state_dict(), f"./pgd_8_255/trained_pgd_ep_{epsilon:.2f}_alpha_{alpha:.2f}.pt")
